                      ...
                      if (constants.temperatureText[index] == 'CE') {
                        ...
                        return ButtonsComponent(
                          ...
                          onTap: () {
                            setState(() {
                              userInput =
                                  constants.temperatureText[index] + userInput;
                            });
                          },
                        );
                      } else {
